  ...
  Gmond = (function() {
    ...
    */
    ...
    Gmond.prototype.add_metric = function(metric) {
      var cluster, hmet, msg_type, _base, _base1, _name;
    ...
    */
    ...
    Gmond.prototype.merge_metric = function(target, hmetric) {
      var extra_elements, key, _i, _len, _ref, _results;
      extra_elements = this.gmetric.extra_elements(hmetric);
      target['info'] || (target['info'] = new Object());
      target['extras'] || (target['extras'] = new Object());
      _ref = Object.keys(hmetric);
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        key = _ref[_i];
        if (__indexOf.call(extra_elements, key) >= 0) {
          _results.push(target['extras'][key] = hmetric[key]);
        } else {
          _results.push(target['info'][key] = hmetric[key]);
        }
      }
      return _results;
    };
